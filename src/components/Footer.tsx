    ...
    <>
      <div className="md:flex align-middle gap-[30px] p-[60px] bg-black">
        <div className="md:w-1/4 mb-[20px] md:mb-[0px]">
          <h1 className="text-white text-2xl font-bold mb-[30px] border-l-blue-600 border-l-[6px] pl-[10px]">
            {" "}
            About Us{" "}
          </h1>
          <Image src="/Logo.webp" alt="panaverse" width={120} height={120} />
          <p className="text-gray-700 pr-[40px] mt-[20px]">
            The Future of the Web is Web 3.0, Metaverse, and Edge Computing.
            Panaverse DAO is a movement to spread
          </p>
        </div>
        <div className="md:w-1/4 mb-[20px] md:mb-[0px]">
          <h1 className="text-white text-2xl font-bold  border-l-blue-600 border-l-[6px] pl-[10px]">
            {" "}
            Useful Links{" "}
          </h1>
          <ul className="text-gray-700 pt-[30px]">
            <li>
